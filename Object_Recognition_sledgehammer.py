...
input_img = r'C:/Users/vitor.franca/projects/tecban/dataset/marretas/images/'
filenames = os.listdir(input_img)
folder = 'replicadas' 
output_img = "{0}{1}/".format(input_img, folder)

output_xml = 'C:/Users/vitor.franca/projects/tecban/dataset/marretas/labels/replicadas_xml/'
input_dir = r'C:/Users/vitor.franca/Documents/img/'
...
def main():
    ...
    for filename in XML_files: 
        ...
        tree.write(output.format(output_xml, i,'xml', pretty_print=True))

...
#------ Funcoes de Apoio
def pad(image, by): #label permanece na imagem quando houver alguma alteração rotacional
...
output_xml = 'C:/Users/vitor.franca/projects/tecban/data_set/'
...
# print(XML_files) # XML_filenames  Essa variavel imprime a lista do editorio e arquivo e extensão xml XML_filenames 
...
def main():
    ...
    for filename in XML_files: 
        filename = filename.replace('\\','/').replace(chr(92), '/') # for substituiu as duas barras invertidas no final do diretorio
        ...
        for j in range(0, 15):
            ...
            image_after = draw_bbs(image_aug, bbs_aug.remove_out_of_image().clip_out_of_image(), 5)
